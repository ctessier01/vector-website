...
**Last updated:** July 28, 2026 · **Version:** 1.4
## At a glance
Vector takes a **data minimization by default** approach, complemented by **radical transparency** about what is collected and why. Here's the essence:
- **Marketing site**: no tracking cookies, no advertising pixels, no third-party tracking scripts. Audience measurement is fully anonymous. If you voluntarily choose to submit a form (for example, to download a guide), your name and email address are then processed as described in Section 6.3.
- **Application**: we collect only the information necessary to provide the Service, measure its use for billing purposes, support you if you no longer seem to be benefiting from it, and prevent fraud within the Ambassador Program.
- **Three product telemetry regimes**: minimal regime (full opt-out available at any time), standard regime (default, with 90-day retention for event telemetry), extended regime (reserved for beta testers, contractually framed). See Section 7.2.
- **Your data is yours**: you can obtain a copy, correct it, transfer it, or delete it at any time.
- **Third-party AI**: the content you enter is never used to train external artificial intelligence models (Anthropic Claude, etc.).
- **Internal learning**: Vector learns from your task durations to personalize your estimates. In strictly aggregated form (statistics by category, by industry), this data may contribute to improving the default estimates offered to all users, without enabling identification of any person (see Section 5).
- **No data sales**: we never sell your personal information to anyone.
This is a summary. The sections below provide the full details.
## 1. Introduction
...
**Privacy Officer**
CapitalSoft inc. — Vector division
Email: confidentialite@vectorplanning.ai
...
- **Payment information**: if you subscribe to a paid plan, your payment provider (Polar) collects the required payment information. **We do not collect or store your credit card numbers or other sensitive financial data.** We only receive the information necessary to manage your subscription (subscription status, plan, renewal date, currency, billing country).
...
- **Technical data**: browser type, operating system, language, time zone, pages viewed on the marketing site. IP addresses collected during your navigation on the marketing site are processed by our audience measurement provider (Cloudflare) without depositing cookies or individually identifying you. IP addresses collected at the time of registration via the Ambassador Program are processed as described in Section 7.3 (rolling salted hash). IP addresses collected at the time of marketing site form submission are processed as described in Section 6.3 (hashing for consent proof purposes). IP addresses collected at the time of acceptance of the beta confidentiality agreement are kept as a salted, non-reversible cryptographic hash, as proof of acceptance; the IP address in clear is never stored.
...
| Purpose | 
Legal basis (GDPR, when applicable) |
| Create and manage your account, authenticate you | Contract performance |
| Provide Application features (planning, AI estimation, calendar) | Contract performance |
| Process payments and manage subscriptions | Contract performance / Legal obligation |
| Communicate with you (notifications, support, service updates) | Contract performance / Legitimate interest |
| Measure your usage of AI features for billing and quota calibration purposes associated with your Plan | Contract performance |
| Improve the Service, fix bugs, measure aggregated usage | Legitimate interest |
| Support you if our indicators show that you no longer seem to be benefiting from the Service (prevention of silent abandonment) | Contract performance |
| Learn from your usage data to improve the accuracy of duration estimates you receive personally | Contract performance |
| Improve the quality of default duration estimates offered to all users, from aggregated statistics | Legitimate interest |
| Validate Activation of a Referee in the Ambassador Program and prevent associated fraud | Contract performance / Legitimate interest |
| Prevent fraud, abuse, and ensure Service security | Legitimate interest / Legal obligation |
| Deliver a resource (guide, ebook, etc.) you voluntarily requested via a marketing site form | Performance of an explicit request |
| Send you a short series of follow-up emails directly related to the resource you downloaded (maximum three emails over fourteen days, one-click unsubscribe in each email) | Legitimate interest |
| Send you regular marketing communications (newsletter, product announcements), only if you have expressly consented via a non-pre-checked checkbox | Express consent |
...
To exercise these rights, write to us at confidentialite@vectorplanning.ai.
...
**Voice dictation:** The Application lets you dictate text by voice. This feature does not use the Vector artificial intelligence described above: it relies on the speech recognition service built into your browser or your device. Depending on the device and browser used, this transcription may be performed locally or by the browser or operating system vendor (for example Apple or Google) — exactly as when you use the microphone on your phone's keyboard. **No audio recording is transmitted to Vector or to its artificial intelligence provider, and Vector retains no audio recording.** Only the transcribed text reaches the Application, and only if you choose to keep it.
...
- **Delivery of the requested resource.** Immediately after your submission, we send you an email containing the download link. This email directly responds to your request: it does not constitute commercial communication.
- **Short series of follow-up emails related to the downloaded resource.** During the **fourteen (14) days** following your submission, you may receive up to **three (3) additional emails**, the content of which remains directly related to the resource you downloaded — for example, a question to understand whether the method helped you, or a complement on its application. Because you explicitly requested a resource on this topic, the *Canadian Anti-Spam Legislation* (CASL) allows us to chain this short series of emails without additional authorization required from you. Each email contains a one-click unsubscribe link; you can opt out at any time.
- **Regular marketing communications (newsletter, product announcements).** You will only receive these communications **if you have expressly checked** the box provided at the time of form submission. This box is **never pre-checked**, in accordance with Law 25 and CASL. You may at any time withdraw this consent by clicking the unsubscribe link present in each email, or by writing to confidentialite@vectorplanning.ai.
...
| Hosting and infrastructure | Cloudflare, Inc. | United States |
| Database and authentication | Supabase, Inc. | United States |
| Artificial intelligence | Anthropic PBC | United States |
| Support flow automation (Lina agent) | n8n GmbH | Germany |
| Payment processing | Polar Software, Inc. | United States |
| Transactional and follow-up email delivery (mini-funnel, newsletter) | Resend, Inc. | United States |
| Marketing site contact forms | Formspree, Inc. | United States |
This list may evolve. An up-to-date version is available upon request at confidentialite@vectorplanning.ai.
...
We do not knowingly collect personal information concerning persons under 18 years of age. If you find that a minor has transmitted personal information to us, please notify us at confidentialite@vectorplanning.ai so that we can proceed with their deletion as soon as possible.
